...
@FacesValidator("mx.gob.hrrb.validadores.HorasValidator")
public class HorasValidator implements Validator{
    ...
    public void validate(FacesContext arg0, UIComponent arg1, Object arg2)
            ...
            if (h1<7 || h1>21){error=true;}
            if (h3<7 || h3>21){error=true;}

            if (error==true){		       	
                    msj.setDetail("La hora no tiene el formato correcto o la hora de inicio y fin son ilógicas");
