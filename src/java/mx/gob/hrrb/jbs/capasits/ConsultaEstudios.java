 ...
 * @author pedro
 */
@ManagedBean (name="estudio")
@SessionScoped
public class ConsultaEstudios implements Serializable{
    private Estudios oEstu;
    private PacienteCapasits oPCapa;
    private String ed, hoy;
    
    
    public ConsultaEstudios() {
        oEstu= new Estudios();
    ...
    public void bus() throws Exception{
        FacesMessage msg = null;
         ...
         FacesContext.getCurrentInstance().addMessage(null,new FacesMessage(FacesMessage.SEVERITY_ERROR, "ERROR","al buscar"));
                ...
                FacesContext.getCurrentInstance().addMessage(null,new FacesMessage(FacesMessage.SEVERITY_WARN, "ALERTA","Ya se realizado la solicitud de estudios de laboratorio de "+oPCapa.getNombreCompleto()));
            }
         }
         else{
                 msg = new FacesMessage(FacesMessage.SEVERITY_ERROR, "ERROR","no se encuentra El Id en la base de datos");
             FacesContext.getCurrentInstance().addMessage(null, msg);
             this.oPCapa=new PacienteCapasits();
            }      
        } 
    }
