 ...
 * @author Rafael
 */
@ManagedBean (name="oGenRecColCtrl")
@ViewScoped

public class GenerarRecColecCtrlJB {
    ...
    private ArrayList<DetalleRecetarioColectivo> arrRecetaRes;
    ...
    public GenerarRecColecCtrlJB() throws Exception{
        ...
        arrRecetaRes = new ArrayList<DetalleRecetarioColectivo>();
        arrRecetaMedSol = new ArrayList<DetalleRecetarioColectivo>();
        arrRecetaMedRes = new ArrayList<DetalleRecetarioColectivo>();
    }
...
////////////////////////////////////////////////////////////////////////////////BUSCA PACIENTE
    ...
    public AreaServicioHRRB[] getListaAreasHosp(){
        try {
            ...
            //oSeleccionado = null;
                ...
                Logger.getLogger(GenerarRecColecCtrlJB.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public void buscaPacienteHOSP(){
        ...
        try{
            arrEpiMed = new ArrayList<EpisodioMedico>(Arrays.asList(
                    oEpisodioMedico.buscarPacientesColectivosSeguroHosp(
                            dFechaActual, oAreaServ.getClave())));
        }catch (Exception e){
            e.printStackTrace();
        }
    }
    ...
    public void buscaPacienteCE(){
        ...
        try{
            arrEpiMed = new ArrayList<EpisodioMedico>(Arrays.asList(
                    oEpisodioMedico.buscarPacientesColectivosSeguroCE(
    ...
    public void guardarRecCol() throws Exception{
        try{
            if(oDetalleRecColec.insertaRecetarioColectivo(arrReceta) == 1){
                FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "Solicitud de medicamento colectivo controlado", "Receta Guardada Correctamente"));
                limpiarTabla();
            }
        }catch(Exception e){
            Logger.getLogger(GenerarRecColecCtrlJB.class.getName()).log(Level.SEVERE, null, e);
        }
    }
...
////////////////////////////////////////////////////////////////////////////////
    ...
    public void registroResurtirMedicamento(){
        oDetalleRecColec.setServicioCobrable(oMedicamento);
        
        if(oDetalleRecColec.getMedicamento().getNombre().equals("") && 
            oDetalleRecColec.getCantSolicitadaArea()==0 && 
            getAreaServ().getClave()==0){
            FacesContext.getCurrentInstance().addMessage(null, 
                    new FacesMessage(FacesMessage.SEVERITY_ERROR, "ERROR", 
                            "Seleccione un medicamento"));
        }else if(oDetalleRecColec.getMedicamento().getNombre()!=null && 
                oDetalleRecColec.getCantSolicitadaArea()!=0 && 
                getAreaServ().getClave()!=0){
            
                oDetalleRecColec.getRecetario().setAreaServ(oAreaServ);
                arrRecetaRes.add(oDetalleRecColec);
                oMedicamento = new Medicamento();
    ...
    public void borrarElementoRes(DetalleRecetarioColectivo obj){
        arrRecetaRes.remove(obj);
        if(arrRecetaRes.isEmpty()){
            sVisibilidadRegistroMed="hidden";
        }else{
            sVisibilidadRegistroMed="visible";
        }
    ...
    public void guardarResurtirMedCol() throws Exception{
        try{
            if(oDetalleRecColec.insertaResurtirMedicamentoColectivo(arrRecetaRes) == 1) {
                FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "Solicitud de Medicamento Colectivo Controlado", "Solicitud Guardada Correctamente"));
                limpiarTabla2();
            }
        }catch(Exception e){
            Logger.getLogger(GenerarRecColecCtrlJB.class.getName()).log(Level.SEVERE, null, e);
...
////////////////////////////////////////////////////////////////////////////////
     ...
     public void buscaMedicamentoSolSur(){
        sVisibilidadTabla="visible";
        try{
            arrRecetaMedSol = new ArrayList<DetalleRecetarioColectivo>(Arrays.asList(oDetalleRecColec.buscarMedicamentoControladoSolicitadosPaciente(dFechaAux, oEpisodioMedico.getArea().getClave(), oEpisodioMedico.getPaciente().getFolioPaciente(), oEpisodioMedico.getClaveEpisodio())));
        }catch (Exception e){
            e.printStackTrace();
        }
    }
    ...
    public void buscaMedicamentoSolSurTot(){
        ...
        try{
            arrRecetaMedSolTot = new ArrayList<DetalleRecetarioColectivo>(
                Arrays.asList(
                    oDetalleRecColec.buscarTotalMedicamentoControladoSolSur(
                            dFechaAux, oAreaServ.getClave())));
...
////////////////////////////////////////////////////////////////////////////////
    ...
    public ArrayList<DetalleRecetarioColectivo> getRecetaRes() {
        return arrRecetaRes;
    }

    public void setRecetaRes(ArrayList<DetalleRecetarioColectivo> arrRecetaRes) {
        this.arrRecetaRes = arrRecetaRes;
    }
