...
@ManagedBean(name = "oPacRef")
@SessionScoped
//@ViewScoped

public class PacientesReferidosHosp{
    ...
    public void generar(){
        ...
        try {
            setAdmision(oAdmisionUrgs.BuscaPacientesReferidos(getFechaI(), getFechaF()));
        } catch (Exception ex) {
