...
@ManagedBean(name = "oPacMunSer")
@SessionScoped
//@ViewScoped

public class PacPorMunicipioServicio{
    private AdmisionUrgs oAdmisionUrgs;
    
    private List<AdmisionUrgs> lAdmision;
    private List<AdmisionUrgs> lAdmisionTotal;
    ...
    private String medGral;
    
    public PacPorMunicipioServicio() throws Exception{
        ...
        setAdmisionTotal(oAdmisionUrgs.BuscaTotalPacientesHosp());
    }
    
    public void buscaTotalHosp() throws Exception{
        setAdmisionTotal(oAdmisionUrgs.BuscaTotalPacientesHosp());
    }
    ...
    public void generar(){
        ...
        try {
            setAdmision(oAdmisionUrgs.BuscaPacientesPorMunicipio(getFechaI(), getFechaF()));
        } catch (Exception ex) {
            Logger.getLogger(PacPorMunicipioServicio.class.getName()).log(Level.SEVERE, null, ex);
        }
        dFechaInicial=null;
        dFechaFinal=null;
    }
    ...
    /**
     * @return the lAdmisionTotal
     */
    public List<AdmisionUrgs> getAdmisionTotal() {
        return lAdmisionTotal;
    }

    /**
     * @param lAdmisionTotal the lAdmisionTotal to set
     */
    public void setAdmisionTotal(List<AdmisionUrgs> lAdmisionTotal) {
        this.lAdmisionTotal = lAdmisionTotal;
    }
}