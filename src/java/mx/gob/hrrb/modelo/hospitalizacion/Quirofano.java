...
public class Quirofano implements Serializable{
	...
	String sQuery = "";
		 if( this==null){   //completar llave
			throw new Exception("Quirofano.buscar: error de programación, faltan datos");
		}else{ 
	...
	String sQuery = "";
		 if( this==null){   //completar llave
			throw new Exception("Quirofano.insertar: error de programación, faltan datos");
		}else{ 
	...
	String sQuery = "";
		 if( this==null){   //completar llave
			throw new Exception("Quirofano.modificar: error de programación, faltan datos");
		}else{ 
	...
	String sQuery = "";
		 if( this==null){   //completar llave
			throw new Exception("Quirofano.eliminar: error de programación, faltan datos");
		}else{ 
