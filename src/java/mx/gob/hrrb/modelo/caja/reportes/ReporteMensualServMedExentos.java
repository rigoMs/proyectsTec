 ...
 * @author Daniel
 */
public class ReporteMensualServMedExentos implements Serializable{
    ...
    public ReporteMensualServMedExentos[] buscarReporte(Date dFechaI,Date dFechaF) throws Exception{
        ReporteMensualServMedExentos arrRet[]=null, oRpt=null;
	ArrayList rst = null;
	String sQuery = "";
	int i=0;
        if(dFechaI==null||dFechaF==null){
            ...
            sQuery = "SELECT * FROM buscaReporteMensualServMedicosAsistExentosconRecibo('"+format.format(dFechaI)+"'::date,'"+format.format(dFechaF)+"'::date);"; 
            oAD=new AccesoDatos(); 
		...
		oAD.desconectar(); 
            ...
            if (rst != null) {
		arrRet = new ReporteMensualServMedExentos[rst.size()];
